...
const CHIP = "h-6 px-2 text-xs font-medium rounded-md border border-border bg-secondary text-muted-foreground hover:bg-accent hover:text-foreground aria-pressed:bg-accent aria-pressed:border-accent aria-pressed:text-foreground transition-colors";
